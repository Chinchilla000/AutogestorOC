...
<div class="card">
        <div class="card-header bg-primary text-white">
            <h1 class="display-5 mb-4 text-center">Agregar Visitador de Obras</h1>
        </div>
        <div class="card-body">
            ...
            <form action="procesar_agregar_visitador_obras.php" method="post">
            <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary">Crear Visitador de Obras</button>
            </form>
        </div>
    </div>
