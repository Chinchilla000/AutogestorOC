...
<nav class="navbar navbar-expand-md navbar-light custom-navbar">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link custom-link  mx-2" href="<?php echo $url_base2; ?>index_usuario_gerente.php"><strong>Inicio</strong></a>
                    </li>
    ...
    <?php if (isset($_SESSION['nombre_gerente'])) : ?>
        <div class="btn-group" role="group">
            <a href="" class="btn btn-primary mx-2"><strong><?php echo $_SESSION['nombre_gerente']; ?> <?php echo $apellido_gerente; ?></strong></a>
        </div>
    <?php endif; ?>
