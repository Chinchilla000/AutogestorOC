<?php include("../templates/header_empresa.php"); ?>
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h1 class="display-5 mb-4 text-center">Agregar Gerente General</h1>
        </div>
        <div class="card-body">
            ...
            <form action="procesar_agregar_gerente_general.php" method="post">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary">Crear Gerente General</button>
            </form>
        </div>
    </div>
